...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__logo">
            <a href="./index.html"><img src="./publics/img/logo.svg" alt=""></a>
        </div>
                    ...
                    <div class="header__right">
                        <div class="header__right__auth">
                            ...
                            if (isset($_SESSION['user'])) {
                                ...
                                $avatar_path = "publics/upload/" . $avatar;
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="">Xin chào,<?= $username ?></a>
                                            <ul class="dropdown">
                                                ...
                                                <?php if ($is_admin == 1) { ?>
                                                    <li><a href="admin/index.php">Vào Admin</a></li> <?php } ?>
