            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form action="index.php?pgs=login" method="post" class="pt-3">
                <div class="form-group">
                  <input type="username" class="form-control form-control-lg" id="exampleInputEmail1" name="username" placeholder="Username">
                </div>
                <div class="form-group">
                  <input type="password" class="form-control form-control-lg" id="exampleInputPassword1" name="password" placeholder="Password">
                </div>
                <div class="mt-3">
                  <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" name="btn_sign_in">SIGN IN</button>
                </div>
                <div class="my-2 d-flex justify-content-between align-items-center">
                  ...
                  <a href="index.php?pgs=forgotpass" class="auth-link text-black">Forgot password?</a>
                </div>
                <div class="mb-2">
